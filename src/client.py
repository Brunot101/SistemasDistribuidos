...
def redrawWindow(win, game, p):
    ...
    if not(game.connected()):
        ...
        text = font.render("Esperando jogador...", 0.2, (255,0,0), True)
        win.blit(text, (width/2 - text.get_width()/2, height/2 - text.get_height()/2))
    else:
        font = pygame.font.SysFont("comicsans", 30)
        text = font.render("Sua escolha", 0.2, (0, 255,255))
...
btn1 = Button("Chat", 550, 50, (0,250,0))
...
def main():
    ...
    while run:
        ...
        try:
            ...
            run = False
            print("Não foi possivel achar um jogo")
            break
        ...
        if game.bothWent():
            ...
            if (game.winner() == 1 and player == 1) or (game.winner() == 0 and player == 0):
                text = font.render("Voce venceu!", 1, (255,0,0))
            elif game.winner() == -1:
                text = font.render("Empate!", 1, (255,0,0))
            else:
                text = font.render("Voce perdeu ...", 1, (255, 0, 0))
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                if btn1.click(pos) and game.connected():
                    webbrowser.open_new_tab('https://chat-gx2ukqqi5q-rj.a.run.app/')
